...
export const OPTIONS = new Collection<string, BaseOption>([
	...
	["queue_1", new QueueOption({ id: "queue_1", description: "" })],
	["queue_2", new QueueOption({ id: "queue_2", description: "" })],
	["queue_3", new QueueOption({ id: "queue_3", description: "" })],
	["queue_4", new QueueOption({ id: "queue_4", description: "" })],
	["queue_5", new QueueOption({ id: "queue_5", description: "" })],
